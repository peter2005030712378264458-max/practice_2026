...
if not exist "%~dp0Qwen3-4B-Thinking-2507-Q4_K_M.gguf" if not exist "%~dp0resources\llm\Qwen3-4B-Thinking-2507-Q4_K_M.gguf" (
  echo Model file not found:
  echo   %~dp0Qwen3-4B-Thinking-2507-Q4_K_M.gguf
  echo   %~dp0resources\llm\Qwen3-4B-Thinking-2507-Q4_K_M.gguf
